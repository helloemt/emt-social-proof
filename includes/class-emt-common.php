...
class Emt_Common {
	...
	/**
	 * This checks the new plugin version on github repo
	 */
	public function check_plugin_update() {
		if ( class_exists( 'WPGitHubUpdater' ) || class_exists( 'WP_GitHub_Updater' ) ) {
			$config = array(
				'plugin_file'        => EMT_PLUGIN_BASENAME,
				'slug'               => 'emt-social-proof',
				'proper_folder_name' => 'emt-social-proof',
				'api_url'            => 'https://api.github.com/repos/helloemt/emt-social-proof',
				'github_url'         => 'https://github.com/helloemt/emt-social-proof',
				'requires'           => '4.2.1',
				'tested'             => '4.9.6',
				'readme'             => 'readme.txt',
				'raw_url'            => 'https://raw.github.com/helloemt/emt-social-proof/master',
				'zip_url'            => 'https://github.com/helloemt/emt-social-proof/zipball/master',
				'sslverify'          => true,
			);
